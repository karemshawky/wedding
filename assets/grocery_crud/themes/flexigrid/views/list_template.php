...
<div class="flexigrid" style='width: 100%;' data-unique-hash="<?php echo $unique_hash; ?>">
        	...
        	<a class="export-anchor" data-url="<?php echo $export_url; ?>" target="_blank">
				<div class="fbutton">
					<div>
						...
						<img src="<?=base_url()?>assets/grocery_crud/themes/flexigrid/css/images/excel.png" title="Microsoft Excel" width="30" height="30">
					</div>
				</div>
            </a>
	...
	<div class="sDiv quickSearchBox" id='quickSearchBox'>
		<div class="sDiv2">
			<?php echo $this->l('list_search');?>: <input type="text" class="qsbsearch_fieldox search_text form-control-sm" name="search_text" size="30" id='search_text'>
			<select name="search_field" id="search_field" class="btn btn-light dropdown-toggle">
