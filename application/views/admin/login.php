...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="logo">
            <a href="<?= base_url() ?>">
                <img src="<?=base_url()?>assets/img/logo255.png" width="280" height="170" alt="" /> </a>
        </div>
        <!-- END LOGO -->
        <!-- BEGIN LOGIN -->
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <?=form_open('backend/users',['class'=>'login-form','method'=>'POST'])?>    
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
                        ...
                        <input class="form-control placeholder-no-fix" type="text" required="required" autocomplete="off" placeholder="أسم المستخدم" name="user_name" /> </div>
                </div>
                <div class="form-group">
            ...
            <?php //=form_open('backend/users/forget',['class'=>'forget-form','method'=>'POST'])?>    
